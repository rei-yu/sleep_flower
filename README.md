...
~~~sh
# getting the code
git clone git@github.com:nko5/wai-wai.git && cd ./wai-wai/
...
# deploying to Modulus (to http://wai-wai.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/wai-wai" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
